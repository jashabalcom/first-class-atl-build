...
import { Plus, Edit2, Trash2, Eye, Image, Save, FileText, Bold, Italic, Quote, List, Link2 } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              {!previewMode && (
                <div className="flex flex-wrap gap-1 p-2 bg-muted rounded-t border border-b-0">
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("bold")} title="Bold">
                    <Bold className="h-4 w-4" />
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("italic")} title="Italic">
                    <Italic className="h-4 w-4" />
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("heading")} title="Heading">
                    H2
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("list")} title="List">
                    <List className="h-4 w-4" />
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("link")} title="Link">
                    <Link2 className="h-4 w-4" />
                  </Button>
                  <span className="border-l mx-2" />
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("dropcap")} title="Drop Cap">
                    Drop Cap
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("callout")} title="Callout">
                    Callout
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("pullquote")} title="Pull Quote">
                    <Quote className="h-4 w-4" />
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("stats")} title="Stats Grid">
                    Stats
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("divider")} title="Divider">
                    ---
                  </Button>
                  <Button type="button" variant="ghost" size="sm" onClick={() => insertShortcode("image")} title="Image">
                    <Image className="h-4 w-4" />
                  </Button>
                </div>
              )}
