      ...
      <main>
        ...
        <AnimatedSection className="py-16 lg:py-24 bg-secondary/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-foreground">Flooring <span className="text-primary">Services</span></h2>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <h2 className="font-display text-3xl md:text-4xl text-foreground mb-6">Complete Flooring <span className="text-primary">Solutions</span></h2>
        ...
        <AnimatedSection className="py-16 lg:py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-foreground">Flooring Installation Across <span className="text-primary">Metro Atlanta</span></h2>
            </div>
        ...
        <AnimatedSection className="py-16 lg:py-24 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl mb-6">Ready for Beautiful New Floors?</h2>
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">Schedule your free flooring consultation today.</p>
